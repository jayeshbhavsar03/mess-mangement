						   ...
						   <?php 
							...
							?>
										<tr>
											...
											<td>
												<input class="meal" type="checkbox" name="attend[<?php echo$rows['phone'];?>]" value="A"> 1 &nbsp 
												<input class="meal" type="checkbox" name="attend[<?php echo$rows['phone'];?>]" value="B"> 2 &nbsp 
												<input class="meal" type="checkbox" name="attend[<?php echo$rows['phone'];?>]" value="C"> 3 &nbsp
											</td>
									  </tr>
